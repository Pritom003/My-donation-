...
const Home = () => {
  return (
    <div>
       ...
       <div className="hero h-[40vh]  " style={{backgroundImage: ' url(https://i.ibb.co/nDGMbYH/Food.png?fbclid=IwAR2_wgP4BrPD7GtY8p_n3kATOicerSlt0jvhk7eKHKRdUlp33UU5ebWvZvU)'}}>
  <div className="hero-overlay rounded bg-opacity-90"></div>
